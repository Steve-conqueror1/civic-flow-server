...
ALTER TABLE "users" ALTER COLUMN "role" SET DEFAULT 'citizen'::text;--> statement-breakpoint
DROP TYPE "public"."user_role";--> statement-breakpoint
CREATE TYPE "public"."user_role" AS ENUM('citizen', 'admin', 'super_admin');--> statement-breakpoint
